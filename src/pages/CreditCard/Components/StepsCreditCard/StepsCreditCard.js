                        ...
                        <div class="lg:w-1/2 md:w-1/2 md:pr-10 md:py-6">
                            <div class="flex relative pb-12">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Check your credit score</p>
                                </div>
                            </div>
                            <div class="flex relative pb-12">
                                <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Compare offers</p>
                                </div>
                            </div>
                            <div class="flex relative pb-12">
                                <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Fill out an online application</p>
                                </div>
                            </div>
                            <div class="flex relative pb-12">
                                <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Submit your application</p>
                                </div>
                            </div>
                            <div class="flex relative">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Receive the card </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='identityproof flex flex-col justify-start'>
                                ...
                                <div class="p-2 pl-0 w-full">
                                    <div class="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div class="flex-grow">
                                            <h2 class="text-gray-900 title-font text-sm font-medium">Identity Proof (Anyone): •	Aadhaar card
                                                •	PAN card
                                                •	Driving license
                                                •	Voter ID card
                                                •	Passport
                                ...
                                <div class="p-2 pl-0 w-full">
                                    <div class="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div class="flex-grow">
                                            <h2 class="text-gray-900 text-sm title-font font-medium">Address Proof: •	Electricity bill
                                                •	Ration card
                                                •	Passport
                                                •	Driving licence
                                                •	Telephone bill
                                ...
                                <div class="p-2 pl-0 w-full">
                                    <div class="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div class="flex-grow">
                                            <h2 class="text-gray-900 text-sm title-font font-medium">•	Latest payslip
                                                •	Form 16
