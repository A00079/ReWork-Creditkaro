        ...
        <React.Fragment>
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">TYPES OF PERSONAL LOAN</h2>
                        <h1 class="title-font sm:text-4xl text-3xl mb-10 font-bold text-indigo-600">TYPES OF PERSONAL LOAN</h1>
