...
const HomeLoanform = (props) => {
    ...
    const onSubmitOtp = (e) => {
        ...
        optConfirm
            ...
            .then(function (result) {
                ...
                saveData();
                props.history.push({ pathname: 'special-offers', type: 'home-loan' });
            })
            .catch(function (error) {
                console.log(error);
                alert("Incorrect OTP");
    ...
    const saveData = () => {
        ...
        axios.post('https://credit.candidleads.com/api/v1/details/adddetail?type=homeloan', data)
...
export default withRouter(HomeLoanform);