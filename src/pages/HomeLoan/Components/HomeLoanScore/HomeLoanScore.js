            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-0 mx-auto">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h2 class="text-xs text-indigo-500 tracking-widest text-left font-medium title-font mb-1">BENEFITS HOME LOAN</h2>
                        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-left text-indigo-600">Benefits of Taking a Home Loan</h1>
                        <p class="lg:w-full leading-relaxed text-left text-base">This type of home loan provides financing for purchasing the plot of land where you would like to construct a house and for the construction, both within a single loan.</p>
                    </div>
